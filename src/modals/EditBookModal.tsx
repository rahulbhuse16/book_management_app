...
const EditBookModal: React.FC<AddBookModalNS.BookModalProps> = ({ isOpen, onClose, onSubmit, initialData }) => {
  const { register, handleSubmit, formState: { errors }, reset } = useForm<AddBookModalNS.BookFormData>({
